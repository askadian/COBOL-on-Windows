      ...
      * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
      *                                                               *
      *  Exam paper model answer. A program is required which will    *
      *  produce a file, sorted on ascending email domain, from the   *
      *  unsorted GraduateInfo file.                                  *
      ...
      * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
       ...
       01 CourseTable.
          02 CourseValues.
             ...
             03 FILLER          PIC X(25) 
                            VALUE "Grad. Dip. Computing".
             03 FILLER          PIC X(25) 
                            VALUE "Grad. Dip. Localisation".
             03 FILLER          PIC X(25) 
                            VALUE "Grad. Dip. Music".
             03 FILLER          PIC X(25) 
                            VALUE "Computing with French".
       ...
       SelectCSISGraduates.
           ...
           PERFORM UNTIL EndOfGradFile
              IF CSISGraduate
                 ...
                 RELEASE WorkRec
              ELSE
                 DISPLAY "Rejected - " StudentNameGF 
                     SPACE CourseCodeGF
              END-IF
              READ GraduateInfoFile
                AT END SET EndOfGradFile TO TRUE
       ...
       LoadCountryTable.
           ...
           PERFORM VARYING Cidx 
              FROM 1 BY 1 UNTIL EndOfCountryFile
