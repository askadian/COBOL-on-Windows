      ...
      * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
      *                                                               *
      *  Exam paper model answer. The Folio Society is a Book Club    *
      *  that sells fine books to customers all over the world. A     *
      *  program is required to print a list of the ten best selling  *
      *  books (by copies sold) in the Book Club.                     *
