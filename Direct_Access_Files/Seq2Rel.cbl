      ...
      *  Note that Relative files are not standard ASCII files and so *
      *  cannot be created with an editor as Sequential files can. To *
      *  create the Relative file you will need to download the       *
      *  supplier file SEQSUPP.DAT                                    *
      *                                                               *
      * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
