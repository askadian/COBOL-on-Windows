      ...
      * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
      *                                                               *
      *  The program accepts a simple student record from the user    *
      *  and displays the individual fields. Also shows how the       *
      *  ACCEPT may be used to get and DISPLAY the system time and    *  
      *  date.                                                        *
      *                                                               *
      * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
      *                                                               *
      ...
      * will only contain two digits which may cause a problem in     *
      *  the year 2000.                                               *
      *                                                               *
      * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
